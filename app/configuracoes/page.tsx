...
export default async function SettingsPage({ searchParams }: SettingsPageProps) {
  ...
  const [{ activeCondominium }, operatorContext] = await Promise.all([
  ...
  return (
    <main className="pageShell">
      ...
      <FeedbackQueryCleanup keys={["tone", "message", "setupLink"]} />

      <section className="stackGrid settingsPageStack">
        <div className="panel">
          ...
          {!activeCondominium ? (
            ...
            <div className="stackGrid settingsGrid">
              {activeOperators.map((operator) => (
                <article key={operator.membership_id} className="settingsCard settingsOperatorCard">
                  <span className="metricIcon metricAccentBlue">
                    <ShieldCheck size={16} />
                  </span>
        ...
        <div className="panel settingsOperatorPanel">
          <div className="panelHeader">
            <div>
              <h2>Novo operador</h2>
            </div>
          ...
          {!activeCondominium ? (
            ...
            <div className="settingsCard settingsFormCard">
              <form action={createOperatorForCondominium} className="deliveryForm">
                ...
                <button className="primaryButton settingsFormButton" type="submit">
